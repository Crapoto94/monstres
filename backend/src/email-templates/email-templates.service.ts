...
export class EmailTemplatesService {
  ...
  async renderPreview(id: string) {
    ...
    const sampleData: Record<string, string> = {
      ...
      item_url: 'https://monstres.app/monstres/demo123',
      item_photo_url: 'https://monstres.app/storage/demo-photo.jpg',
      verification_url: 'https://monstres.app/verifier-email?token=demo',
      reset_url: 'https://monstres.app/reinitialiser-mot-de-passe?token=demo',
