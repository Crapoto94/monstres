  ...
  <section class="flex-1 p-4">
    <div class="mx-auto max-w-sm">
      ...
      <div class="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
        <h1 class="text-xl font-bold text-gray-900 dark:text-gray-100">Inscription</h1>
        ...
        <p class="mt-5 text-center text-sm text-gray-500 dark:text-gray-400">
          Déjà un compte ?
          <RouterLink to="/connexion" class="font-medium text-brand-600 dark:text-brand-400">Se connecter</RouterLink>
        </p>
      </div>
    </div>
  </section>
